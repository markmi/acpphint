...
FNAMEPREFIX=     "OPi+2E-FBSD/acpphint-OPi+2E-2048MiB-threads_4-ILP32-FreeBSD_13_r363590M-" . COMPILERLIBRARY
COMPILERLIBRARY2="g++_10_O3lto-libc++"
FNAME2PREFIX=    "OPi+2E-FBSD/acpphint-OPi+2E-2048MiB-threads_4-ILP32-FreeBSD_13_r363590M-" . COMPILERLIBRARY2
RAMLOWERBOUND=   64
RAMUPPERBOUND=   2**34
QUIPSUPPERBOUND= 1.2e7
TIMELOWERBOUND=  1e-8
TIMEUPPERBOUND=  1.6
...
plot [RAMLOWERBOUND:RAMUPPERBOUND][0:QUIPSUPPERBOUND] \
 FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_4_threads.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_4_threads-cpus_0_1_2_3.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_0_1_2_3.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_3_threads-cpus_0_1_2.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_3_threads-cpus_0_1_2.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_0_3.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_3.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_1_2.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_1_2.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_0_2.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_2.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_1_3.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_1_3.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_0_1.txt" using 4:2 with linespoints linecolor rgb "red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_1.txt" using 4:2 with linespoints linecolor rgb "red" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_2_3.txt" using 4:2 with linespoints linecolor rgb "red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_2_3.txt" using 4:2 with linespoints linecolor rgb "red" \
,FNAME2PREFIX . "-DSIZE_ui-ISIZE_ui-using_1_threads.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_1_threads.txt" using 4:2 with linespoints linecolor rgb "dark-grey" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_4_threads.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_4_threads-cpus_0_1_2_3.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_0_1_2_3.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_3_threads-cpus_0_1_2.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_3_threads-cpus_0_1_2.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_0_3.txt" using 4:2 with linespoints linecolor rgb "light-green" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_3.txt" using 4:2 with linespoints linecolor rgb "light-green" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_1_2.txt" using 4:2 with linespoints linecolor rgb "light-green" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_1_2.txt" using 4:2 with linespoints linecolor rgb "light-green" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_0_2.txt" using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_2.txt" using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_1_3.txt" using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_1_3.txt" using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_0_1.txt" using 4:2 with linespoints linecolor rgb "light-goldenrod" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_1.txt" using 4:2 with linespoints linecolor rgb "light-goldenrod" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_2_threads-cpus_2_3.txt" using 4:2 with linespoints linecolor rgb "light-goldenrod" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_2_3.txt" using 4:2 with linespoints linecolor rgb "light-goldenrod" \
,FNAMEPREFIX . "-DSIZE_ui-ISIZE_ui-using_1_threads.txt" using 4:2 with linespoints linecolor rgb "light-grey" \
