...
plot [RAMLOWERBOUND:RAMUPPERBOUND][0:QUIPSUPPERBOUND] \
 FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads.txt"          using 4:2 with linespoints linecolor rgb "grey" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads.txt"            using 4:2 with linespoints linecolor rgb "grey" \
,FNAME2PREFIX . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_4_threads.txt"   using 4:2 with linespoints linecolor rgb "light-pink" \
,FNAME2PREFIX . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_4_threads.txt"     using 4:2 with linespoints linecolor rgb "light-pink" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_0_2.txt"      using 4:2 with linespoints linecolor rgb "light-turquoise" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_2.txt"        using 4:2 with linespoints linecolor rgb "light-turquoise" \
,FNAME2PREFIX . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_2_threads.txt"   using 4:2 with linespoints linecolor rgb "light-salmon" \
,FNAME2PREFIX . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_2_threads.txt"     using 4:2 with linespoints linecolor rgb "light-salmon" \
...
,FNAME2PREFIX . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_1_threads.txt"   using 4:2 with linespoints linecolor rgb "violet" \
,FNAME2PREFIX . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_1_threads.txt"     using 4:2 with linespoints linecolor rgb "violet" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_16_threads.txt"              using 4:2 with linespoints linecolor rgb "olive" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_16_threads.txt"                using 4:2 with linespoints linecolor rgb "olive" \
...
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_8_threads.txt"               using 4:2 with linespoints linecolor rgb "dark-khaki" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_8_threads.txt"                 using 4:2 with linespoints linecolor rgb "dark-khaki" \
...
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_4_threads.txt"   using 4:2 with linespoints linecolor rgb "dark-pink" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_4_threads.txt"     using 4:2 with linespoints linecolor rgb "dark-pink" \
...
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_2_threads.txt"   using 4:2 with linespoints linecolor rgb "dark-salmon" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_2_threads.txt"     using 4:2 with linespoints linecolor rgb "dark-salmon" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ull-ISIZE_ull-using_1_threads.txt"   using 4:2 with linespoints linecolor rgb "dark-violet" \
,FNAMEPREFIX  . "-cpulockdown-DSIZE_ul-ISIZE_ul-using_1_threads.txt"     using 4:2 with linespoints linecolor rgb "dark-violet"
#    EOF
