...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_0_15.txt"             using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_0_15.txt"               using 4:2 with linespoints linecolor rgb "dark-green" \
...
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_0_15.txt"             using 4:2 with linespoints linecolor rgb "light-green" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_0_15.txt"               using 4:2 with linespoints linecolor rgb "light-green" \
