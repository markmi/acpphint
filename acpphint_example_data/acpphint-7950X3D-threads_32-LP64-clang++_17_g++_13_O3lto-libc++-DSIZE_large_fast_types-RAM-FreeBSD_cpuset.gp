...
plot [RAMLOWERBOUND:RAMUPPERBOUND][0:QUIPSUPPERBOUND] \
 FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_kx2s_0_30.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_kx2s_0_30.txt"   using 4:2 with linespoints linecolor rgb "dark-green" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_32_threads.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_32_threads.txt"   using 4:2 with linespoints linecolor rgb "dark-green" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_kx4_kx4p1_0_29.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_kx4_kx4p1_0_29.txt"   using 4:2 with linespoints linecolor rgb "dark-red" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_8_threads-cpus_kx2s_0_6_16_22.txt" using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_8_threads-cpus_kx2s_0_6_16_22.txt"   using 4:2 with linespoints linecolor rgb "dark-blue" \
...
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_8_threads-cpus_kx2s_0_6_16_22.txt" using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_8_threads-cpus_kx2s_0_6_16_22.txt"   using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx16_kx16p2_16_18_24_26.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx16_kx16p2_16_18_24_26.txt"   using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx16_kx16p4_16_20_24_28.txt"   using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx8p2_kx8p4_18_20_26_28.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx8p2_kx8p4_18_20_26_28.txt"   using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx16_kx16p4_16_20_24_28.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx16_kx16p2_0_2_16_18.txt" using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx16_kx16p2_0_2_16_18.txt"   using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx16_kx16p4_0_4_16_20.txt" using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx16_kx16p4_0_4_16_20.txt"   using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx8s_0_24.txt"             using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx8s_0_24.txt"               using 4:2 with linespoints linecolor rgb "dark-blue" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx16_kx16p1_16_17_24_25.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx16_kx16p1_16_17_24_25.txt"   using 4:2 with linespoints linecolor rgb "dark-red" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx16_kx16p1_0_1_16_17.txt" using 4:2 with linespoints linecolor rgb "dark-turquoise" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx16_kx16p1_0_1_16_17.txt"   using 4:2 with linespoints linecolor rgb "dark-turquoise" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_16_24.txt" using 4:2 with linespoints linecolor rgb "dark-magenta" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_16_24.txt"   using 4:2 with linespoints linecolor rgb "dark-magenta" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_0_16.txt" using 4:2 with linespoints linecolor rgb "dark-pink" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_16.txt"   using 4:2 with linespoints linecolor rgb "dark-pink" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_16_17.txt" using 4:2 with linespoints linecolor rgb "dark-goldenrod" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_16_17.txt"   using 4:2 with linespoints linecolor rgb "dark-goldenrod" \
