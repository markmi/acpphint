...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_2_threads.txt"  using 1:2 with linespoints linecolor rgb "light-red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads.txt"    using 1:2 with linespoints linecolor rgb "light-red" \
...
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_2_threads.txt"  using 1:2 with linespoints linecolor rgb "dark-red" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_2_threads.txt"    using 1:2 with linespoints linecolor rgb "dark-red" \
