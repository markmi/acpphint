...
FNAMEPREFIX=     "HoneyComb-STOPTM_6/acpphint-HoneyComb-65536MiB-threads_16-LP64-Fedora_34_64bit-" . COMPILERLIBRARY
COMPILERLIBRARY2=COMPILERLIBRARY
FNAME2PREFIX=    "HoneyComb-Fedora/acpphint-HoneyComb-65536MiB-threads_16-LP64-Fedora_34_64bit-" . COMPILERLIBRARY2
RAMLOWERBOUND=   64
RAMUPPERBOUND=   2**37
QUIPSUPPERBOUND= 2e8
TIMELOWERBOUND=  1e-8
...
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_2_10.txt"                 using 1:2 with linespoints linecolor rgb "light-turquoise" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_2_10.txt"                   using 1:2 with linespoints linecolor rgb "light-turquoise" \
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_2_3.txt"                  using 1:2 with linespoints linecolor rgb "light-salmon" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_2_3.txt"                    using 1:2 with linespoints linecolor rgb "light-salmon" \
