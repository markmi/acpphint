...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_0_15.txt" using 4:2 with linespoints linecolor rgb "light-pink" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_0_15.txt"   using 4:2 with linespoints linecolor rgb "light-pink" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_0_15.txt"  using 4:2 with linespoints linecolor rgb "light-grey" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_0_15.txt"    using 4:2 with linespoints linecolor rgb "light-grey" \
...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_2_threads-cpus_0_15.txt"  using 4:2 with linespoints linecolor rgb "light-turquoise" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_2_threads-cpus_0_15.txt"    using 4:2 with linespoints linecolor rgb "light-turquoise" \
