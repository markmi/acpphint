...
plot [RAMLOWERBOUND:RAMUPPERBOUND][0:QUIPSUPPERBOUND] \
 FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_8_threads_creation_untimed-cpus_kx2s_16_18_28_30.txt" using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_8_threads_creation_untimed-cpus_kx2s_16_18_28_30.txt"   using 4:2 with linespoints linecolor rgb "dark-green" \
...
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_8_threads_creation_untimed-cpus_kx4p1s_1_29.txt" using 4:2 with linespoints linecolor rgb "grey" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_8_threads_creation_untimed-cpus_kx4p1s_1_29.txt"   using 4:2 with linespoints linecolor rgb "grey" \
...
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_8_threads_creation_untimed-cpus_kx4_kx4p1_0_13.txt" using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_8_threads_creation_untimed-cpus_kx4_kx4p1_0_13.txt"   using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_8_threads_creation_untimed-cpus_kx4_kx4p1_0_5_16_21.txt" using 4:2 with linespoints linecolor rgb "dark-turquoise" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_8_threads_creation_untimed-cpus_kx4_kx4p1_0_5_16_21.txt" using 4:2 with linespoints linecolor rgb "dark-turquoise"
#    EOF
