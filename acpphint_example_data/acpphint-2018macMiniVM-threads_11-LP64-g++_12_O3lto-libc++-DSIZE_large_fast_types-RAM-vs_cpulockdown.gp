...
plot [RAMLOWERBOUND:RAMUPPERBOUND][0:QUIPSUPPERBOUND] \
 FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_10_threads-cpus_kp1_1_10.txt"            using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_10_threads-cpus_kp1_1_10.txt"              using 4:2 with linespoints linecolor rgb "light-blue" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_6_threads-cpus_kx4p1_kx4p2_1_10.txt"     using 4:2 with linespoints linecolor rgb "light-red" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_6_threads-cpus_kx4p1_kx4p2_1_10.txt"       using 4:2 with linespoints linecolor rgb "light-red" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_5_threads-cpus_kx4p2_kx4p3_2_10.txt"     using 4:2 with linespoints linecolor rgb "light-green" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_5_threads-cpus_kx4p2_kx4p3_2_10.txt"       using 4:2 with linespoints linecolor rgb "light-green" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx8p1_kx8p3_1_3_9_10.txt" using 4:2 with linespoints linecolor rgb "light-goldenrod" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx8p1_kx8p3_1_3_9_10.txt"   using 4:2 with linespoints linecolor rgb "light-goldenrod" \
...
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_10_threads-cpus_kp1_1_10.txt"            using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_10_threads-cpus_kp1_1_10.txt"              using 4:2 with linespoints linecolor rgb "dark-blue" \
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_6_threads-cpus_kx4p1_kx4p2_1_10.txt"     using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_6_threads-cpus_kx4p1_kx4p2_1_10.txt"       using 4:2 with linespoints linecolor rgb "dark-red" \
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_5_threads-cpus_kx4p2_kx4p3_2_10.txt"     using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_5_threads-cpus_kx4p2_kx4p3_2_10.txt"       using 4:2 with linespoints linecolor rgb "dark-green" \
,FNAMEPREFIX  . "-DSIZE_ull-ISIZE_ull-using_4_threads-cpus_kx8p1_kx8p3_1_3_9_10.txt" using 4:2 with linespoints linecolor rgb "dark-goldenrod" \
,FNAMEPREFIX  . "-DSIZE_ul-ISIZE_ul-using_4_threads-cpus_kx8p1_kx8p3_1_3_9_10.txt"   using 4:2 with linespoints linecolor rgb "dark-goldenrod" \
