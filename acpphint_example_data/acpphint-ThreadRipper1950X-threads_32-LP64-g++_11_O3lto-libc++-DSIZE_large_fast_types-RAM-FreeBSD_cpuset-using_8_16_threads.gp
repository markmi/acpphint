...
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_kx2s_0_30.txt"             using 4:2 with linespoints linecolor rgb "dark-magenta" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_kx2s_0_30.txt"               using 4:2 with linespoints linecolor rgb "dark-magenta" \
,FNAME2PREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_kx4_kx4p1_0_29.txt"        using 4:2 with linespoints linecolor rgb "dark-pink" \
,FNAME2PREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_kx4_kx4p1_0_29.txt"          using 4:2 with linespoints linecolor rgb "dark-pink" \
...
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_kx2s_0_30.txt"             using 4:2 with linespoints linecolor rgb "light-magenta" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_kx2s_0_30.txt"               using 4:2 with linespoints linecolor rgb "light-magenta" \
,FNAMEPREFIX . "-DSIZE_ull-ISIZE_ull-using_16_threads-cpus_kx4_kx4p1_0_29.txt"        using 4:2 with linespoints linecolor rgb "light-pink" \
,FNAMEPREFIX . "-DSIZE_ul-ISIZE_ul-using_16_threads-cpus_kx4_kx4p1_0_29.txt"          using 4:2 with linespoints linecolor rgb "light-pink" \
